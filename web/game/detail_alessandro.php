...
<head>
    ...
    function field($id){
      ...
      $stmt = $conn->prepare("SELECT game.name, developer, publishers.name AS publisher, game_genre.name AS genre, multiplayer, singleplayer, launch_date
       FROM game
                          ...
                          <div class="container-fluid">
                            <div class="row">
                              ...
                              <boarderbox class="col-lg-5">
                                <box class="col-sm-6">
                                  <div class="col-sm-12">
                                    <p> Name: <?php echo $show[0][0] ?><br></p>
                                    <p> Developer: <?php echo $show[0][1] ?><br></p>
                                    <p> Publisher: <?php echo $show[0][2] ?><br></p>
                                    <p> Genre: <?php echo $show[0][3] ?><br></p>
