                        ...
                        <form role="form"
                          ...
                          <div class="form-group">
                              ...
                              <label class="radio-inline">
                                  <input type="radio" name="wilderness_grade" value="firstgrade" checked>Selva Primaria
                              </label>
                              <label class="radio-inline">
                                  <input type="radio" name="wilderness_grade" value="secondgrade">Selva Secondaria
                              </label>
                              <label class="radio-inline">
                                  <input type="radio" name="wilderness_grade" value="thirdgrade">Selva Terziaria
                              </label>
                          </div>
                          ...
                          <div class="form-group">
                              ...
                              <select class="form-control" name="reachability" id="reachability">
                                  <option> Via terra con auto 4x4</option>
                                  <option> Via fiume con peke peke</option>
                                  <option>Via fiume con barca a motore</optio>
                                  <option>Via fiume con barca a motore e peke peke</option>
                              </select>
                          </div>
                          ...
                          <div class="form-group">
                              ...
                              <select class="form-control" name="flood_grade" id="flood_grade">
                                  <option>Nessun Danno</option>
                                  <option> Danni lievi</option>
                                  <option>Qualche danno</option>
                                  <option>Danni gravi</option>
                                    <option>Danni molto gravi</option>
                              </select>
                          </div>
                          ...
                          <div class="form-group">
                                <label> Tipologie di modulo di sostegno che verranno consegnate </label>
                                    <div class="checkbox" name="help_kit" id="help_kit">
                                      <label>
                                        <input type="checkbox" value> Modulo Tetti
                                     </label>
                                    </div>
                                    <div class="checkbox">
                                      <label>
                                        <input type="checkbox" value> Modulo Casa
                                     </label>
                                    </div>
                                    <div class="checkbox">
                                      <label>
                                        <input type="checkbox" value> Modulo Agricolo
                                     </label>
                                    </div>
                                    <div class="checkbox">
                                      <label>
                                        <input type="checkbox" value> Modulo Allevamento
                                     </label>
                                    </div>
                            ...
                            <div class="form-group">
                                    <label> Infrastrutture presenti nella comunità </label>
                                     <div class="checkbox"  name="infrastructure" id="infrastructure">
                                       <label>
                                        <input type="checkbox" value> Energia Elettrica
                                       </label>
                                      </div>
                                      <div  class="checkbox">
                                        <label>
                                         <input type="checkbox" value> Strade non asfaltate
                                        </label>
                                       </div>
                                       <div  class="checkbox">
                                         <label>
                                          <input type="checkbox" value> Strade asfaltate
                                         </label>
                                        </div>
                                       <div  class="checkbox">
                                         <label>
                                          <input type="checkbox" value> Attività commerciali
                                         </label>
                                        </div>
                                        <div  class="checkbox">
                                          <label>
                                           <input type="checkbox" value> Presidio medico
                                          </label>
                                         </div>
                            </div>
